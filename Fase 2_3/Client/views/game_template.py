...
"")
        icon3 = QIcon()
        icon3.addFile(u"images/maximizar.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        icon4 = QIcon()
        icon4.addFile(u"images/cerrar.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        icon5 = QIcon()
        icon5.addFile(u"images/inteligencia-artificial.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u"images/base-de-datos.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u"images/chip.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u"images/moto.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon9 = QIcon()
        icon9.addFile(u"images/encriptado.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u"images/videojuego.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        self.tableWidget.setGeometry(QRect(0, 80, 641, 431))
        ...
        self.bt_comprar.setStyleSheet(u"font: 57 italic 11pt \"Fira Sans Medium\";")
        icon12 = QIcon()
        icon12.addFile(u"../images/add.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.pushButton = QPushButton(self.page_dos)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(450, 20, 51, 31))
...
"font: 11pt \"Noto Sans Carian\";")
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 612, 773))
        ...
        self.label_3.setPixmap(QPixmap(u"../../../archivos/AVL.png"))
...
"font: 87 18pt \"Arial Black\";")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 4139, 3455))
        self.gridLayout_5 = QGridLayout(self.scrollAreaWidgetContents_2)
        self.gridLayout_5.setObjectName(u"gridLayout_5")
        self.label_4 = QLabel(self.scrollAreaWidgetContents_2)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setPixmap(QPixmap(u"../../../archivos/dispersa.png"))
...
"font: 87 18pt \"Arial Black\";")
        ...
        icon14 = QIcon()
        icon14.addFile(u"../images/shoot.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_Disparo.setIcon(icon14)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 4139, 3455))
        self.gridLayout_2 = QGridLayout(self.scrollAreaWidgetContents)
        self.gridLayout_2.setObjectName(u"gridLayout_2")
        self.label_5 = QLabel(self.scrollAreaWidgetContents)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setPixmap(QPixmap(u"../../../archivos/dispersa.png"))
...
"font: 63 9pt \"Noto Serif CJK KR SemiBold\";")
        ...
        self.gridLayout = QGridLayout(self.page_seis)
        self.gridLayout.setObjectName(u"gridLayout")
        self.bt_y = QPushButton(self.page_seis)
        self.bt_y.setObjectName(u"bt_y")
        self.bt_y.setStyleSheet(u"background-color: rgb(170, 170, 127);")

        self.gridLayout.addWidget(self.bt_y, 2, 3, 1, 2)

        self.lineEdit_y = QLineEdit(self.page_seis)
        self.lineEdit_y.setObjectName(u"lineEdit_y")

        self.gridLayout.addWidget(self.lineEdit_y, 2, 5, 1, 1)

        self.bt_Disparo = QPushButton(self.page_seis)
        self.bt_Disparo.setObjectName(u"bt_Disparo")
        self.bt_Disparo.setStyleSheet(u"background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(228, 73, 73, 255), stop:0.55 rgba(235, 148, 61, 255), stop:0.98 rgba(0, 0, 0, 255), stop:1 rgba(0, 0, 0, 0));")
        icon14 = QIcon()
        icon14.addFile(u"../images/shoot.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.scrollArea = QScrollArea(self.page_seis)
        self.scrollArea.setObjectName(u"scrollArea")
        self.scrollArea.setWidgetResizable(True)
        self.scrollAreaWidgetContents = QWidget()
        self.scrollAreaWidgetContents.setObjectName(u"scrollAreaWidgetContents")
        ...
        self.bt_x = QPushButton(self.page_seis)
        self.bt_x.setObjectName(u"bt_x")
        self.bt_x.setStyleSheet(u"background-color: rgb(170, 170, 127);")

        self.gridLayout.addWidget(self.bt_x, 2, 0, 1, 1)

        self.lineEdit_x = QLineEdit(self.page_seis)
        self.lineEdit_x.setObjectName(u"lineEdit_x")

        self.gridLayout.addWidget(self.lineEdit_x, 2, 1, 1, 2)

        self.sizeLineEdit = QLineEdit(self.page_seis)
        self.sizeLineEdit.setObjectName(u"sizeLineEdit")

        self.gridLayout.addWidget(self.sizeLineEdit, 0, 1, 1, 1)

        self.bt_tamanio = QPushButton(self.page_seis)
        self.bt_tamanio.setObjectName(u"bt_tamanio")
        self.bt_tamanio.setStyleSheet(u"background-color: rgb(194, 194, 194);\n"
"font: 63 9pt \"Noto Serif CJK KR SemiBold\";")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bt_seis.setText(QCoreApplication.translate("MainWindow", u"JUGAR PVP", None))
        ...
        self.pushButton_4.setText(QCoreApplication.translate("MainWindow", u"Total   2345", None))
